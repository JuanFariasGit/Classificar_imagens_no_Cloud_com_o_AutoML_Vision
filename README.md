...
4º Abra o cloud shell
5º Cria uma variavel de ambiente para o nome do bucket chamada BUCKET_NAME
6º Verificar se a variavel de ambiente foi criada corretamente
7º Criar um bucket
